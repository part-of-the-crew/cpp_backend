...
public:
    ...
    virtual void AddBook(const std::string& title, const std::string& author_id, int publication_year,
        const std::vector<std::string>& tags) = 0;
    virtual BookInfoExtra GetBookInfo(const std::string& book_id) = 0;
