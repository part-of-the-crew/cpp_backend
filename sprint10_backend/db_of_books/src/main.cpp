...
/*
constexpr auto ACTION_KEY = "action";
constexpr auto PAYLOAD_KEY = "payload";
constexpr auto TITLE_KEY = "title";
constexpr auto AUTHOR_KEY = "author";
constexpr auto YEAR_KEY = "year";
constexpr auto ISBN_KEY = "ISBN";
*/
