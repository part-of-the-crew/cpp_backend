...
public:
    ...
    typedef std::vector<T*>::const_iterator const_it;
    typedef std::vector<T*>::iterator it;
    auto cbegin() const noexcept { return this->items_.cbegin(); }
    auto cend() const noexcept { return this->items_.cend(); }
    auto begin() const noexcept { return this->items_.cbegin(); }
    auto end() const noexcept { return this->items_.cend(); }
    auto begin() noexcept { return this->items_.begin(); }
    auto end() noexcept { return this->items_.end(); }
private:
