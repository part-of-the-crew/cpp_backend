...
public:
    ...
    void AddDocument(int document_id, const string& document, const vector<int> &ratings) {
        ...
        documents_av_ratings.push_back(ComputeAverageRating(ratings));
    }
...
private:
    ...
    vector <int> documents_av_ratings;
    ...
    vector<Document> FindAllDocuments(const Query& query) const {
        ...
        for (const auto &[document_id, relevance] : document_to_relevance) {
            matched_documents.push_back({document_id, relevance, documents_av_ratings.at(document_id)});
        }
        return matched_documents;
    }
...
SearchServer CreateSearchServer() {
    ...
    for (int document_id = 0; document_id < document_count; ++document_id) {
        ...
        const int ratings_count = ReadNumbersInLine();
        vector<int> ratings(ratings_count);
        for (int i = 0; i < ratings_count; ++i) {
            ratings.at(i) = ReadNumbersInLine();
        }
        ReadLine();
